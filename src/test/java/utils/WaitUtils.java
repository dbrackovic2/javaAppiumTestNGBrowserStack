...
public class WaitUtils {
    ...
    /*** This method is for static wait** @param millis*/
    ...
    /*** To wait for button to be clickable** @param driver* @param element*/
    ...
    /*** To wait for element to be visible for given amount of time** @param element* @param driver* @param time*/
