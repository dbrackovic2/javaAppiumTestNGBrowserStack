...
public class CommonUtils {
    ...
    /*** @param input* @return the array separated by comma from the string passed*/
    ...
    /*** Converts Boolean into Numeric String, 1 or 0. Returns null in case arg is* null.** @param arg* @return - Numerical String representation of boolean*/
